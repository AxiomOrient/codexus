...
define_protocol_object_type!(FsWatchParams);
define_protocol_object_type!(FsWatchResponse);
define_protocol_object_type!(FsUnwatchParams);
define_protocol_object_type!(FsUnwatchResponse);
...
define_protocol_object_type!(ExperimentalFeatureEnablementSetParams);
define_protocol_object_type!(ExperimentalFeatureEnablementSetResponse);
...
define_protocol_object_type!(FsChangedNotification);
